document.addEventListener('DOMContentLoaded', function() {
    ...
    const products = [
        ...
        },
        {
            ...
            rating: 4.5,
            reviewCount: 98,
            description: "Soft and comfortable t-shirt for everyday wear. Modern design with great fit.",
            gender: "unisex",
            type: "shirt",
            occasion: "casual",
            colors: ["white", "black"],
        ...
        },
        {
            ...
            rating: 4.3,
            reviewCount: 76,
            description: "Stylish casual shirt with modern cut. Perfect for a night out or casual office wear.",
            gender: "men",
            type: "shirt",
            occasion: "casual",
            colors: ["blue", "white"],
